...
store = storeAll.select('samples',where=('distNearestRaws < 20000','distNearestRaws > -9999.0'))
store = store.replace(-9999.0,np.NaN).dropna(axis=0,how='any')

store1 = storeAll.select('samples',where=('distNearestRaws < 5000','distNearestRaws > -9999.0'))
store1 = store1.replace(-9999.0,np.NaN).dropna(axis=0,how='any')

store2 = storeAll.select('samples',where=('distNearestRaws < 2500','distNearestRaws > -9999.0'))
store2 = store2.replace(-9999.0,np.NaN).dropna(axis=0,how='any')

store3 = storeAll.select('samples',where=('distNearestRaws < 1000','distNearestRaws > -9999.0'))
store3 = store3.replace(-9999.0,np.NaN).dropna(axis=0,how='any')

print("Results below for using instances with distNearestRaws < 20,000")
...
feature_importancesGB = [(featuresGB,round(importancesGB,2)) for featuresGB, importancesGB in zip(feature_listGB,importancesGB)]
...
plt.savefig('ResidualPlot20000.png')


#########
print("Results below for using instances with distNearestRaws < 5,000")
# As example, set-up one random forest to train on
dFMC = store1['fuelMoisture']
#index = store1['index']
distNearestRaws = store1['distNearestRaws']
ndvi = store1['ndvi']
ndwi = store1['ndwi']
gvmi = store1['gvmi']
pmi = store1['pmi']
vari = store1['vari']
b1 = store1['one_km_Surface_Reflectance_Band_1']
b2 = store1['one_km_Surface_Reflectance_Band_2']
b3 = store1['one_km_Surface_Reflectance_Band_3']
b4 = store1['one_km_Surface_Reflectance_Band_4']
b5 = store1['one_km_Surface_Reflectance_Band_5']
b6 = store1['one_km_Surface_Reflectance_Band_6']
b7 = store1['one_km_Surface_Reflectance_Band_7']
Ind = np.array([ndvi,ndwi,gvmi,pmi,vari,dFMC])
Bands = np.array([b1,b2,b3,b4,b5,b6,b7,dFMC])
featuresI = ['ndvi','ndwi','gvmi','pmi','vari']
featuresB = ['b1','b2','b3','b4','b5','b6','b7']
...
# Test adding in GVMI as a predictor with the reflectances
featuresBG = ['b1','b2','b3','b4','b5','b6','b7','gvmi']
GBands = np.array([b1,b2,b3,b4,b5,b6,b7,gvmi,dFMC])
GBands = GBands.transpose()
predictorsGB = GBands[:,0:8]
predictandGB = GBands[:,8]
...
plt.ylabel('Residuals',fontsize=16)
plt.xlabel('Dead FMC', fontsize = 16)
plt.savefig('ResidualPlot5000.png')


###################
print("Results below for using instances with distNearestRaws < 2,500")
# As example, set-up one random forest to train on
dFMC = store2['fuelMoisture']
#index = store2['index']
distNearestRaws = store2['distNearestRaws']
ndvi = store2['ndvi']
ndwi = store2['ndwi']
gvmi = store2['gvmi']
pmi = store2['pmi']
vari = store2['vari']
b1 = store2['one_km_Surface_Reflectance_Band_1']
b2 = store2['one_km_Surface_Reflectance_Band_2']
b3 = store2['one_km_Surface_Reflectance_Band_3']
b4 = store2['one_km_Surface_Reflectance_Band_4']
b5 = store2['one_km_Surface_Reflectance_Band_5']
b6 = store2['one_km_Surface_Reflectance_Band_6']
b7 = store2['one_km_Surface_Reflectance_Band_7']
Ind = np.array([ndvi,ndwi,gvmi,pmi,vari,dFMC])
Bands = np.array([b1,b2,b3,b4,b5,b6,b7,dFMC])
featuresI = ['ndvi','ndwi','gvmi','pmi','vari']
featuresB = ['b1','b2','b3','b4','b5','b6','b7']
...
plt.ylabel('Residuals',fontsize=16)
plt.xlabel('Dead FMC', fontsize = 16)
plt.savefig('ResidualPlot2500.png')


#########################
print("Results below for using instances with distNearestRaws < 1,000")
# As example, set-up one random forest to train on
dFMC = store3['fuelMoisture']
#index = store3['index']
distNearestRaws = store3['distNearestRaws']
ndvi = store3['ndvi']
ndwi = store3['ndwi']
gvmi = store3['gvmi']
pmi = store3['pmi']
vari = store3['vari']
b1 = store3['one_km_Surface_Reflectance_Band_1']
b2 = store3['one_km_Surface_Reflectance_Band_2']
b3 = store3['one_km_Surface_Reflectance_Band_3']
b4 = store3['one_km_Surface_Reflectance_Band_4']
b5 = store3['one_km_Surface_Reflectance_Band_5']
b6 = store3['one_km_Surface_Reflectance_Band_6']
b7 = store3['one_km_Surface_Reflectance_Band_7']
Ind = np.array([ndvi,ndwi,gvmi,pmi,vari,dFMC])
Bands = np.array([b1,b2,b3,b4,b5,b6,b7,dFMC])
featuresI = ['ndvi','ndwi','gvmi','pmi','vari']
featuresB = ['b1','b2','b3','b4','b5','b6','b7']
...
plt.ylabel('Residuals',fontsize=16)
plt.xlabel('Dead FMC', fontsize = 16)
plt.savefig('ResidualPlot1000.png')
